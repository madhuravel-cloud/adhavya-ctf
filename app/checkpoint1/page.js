  ...
  return(
    <main className="container">
      ...
      <div className="hint">
        ...
        <p>The battle was recorded carefully, but the important details may not be where you expect them.</p>
        <p>Every exchange has a beginning and an end. Sometimes the end tells you more than the beginning.</p>
